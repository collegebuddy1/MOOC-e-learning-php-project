		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					<li class="active"><a href="/etudianthome">Acceuil</a></li>
					<li><a href="/etudiantformation">Formation</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Categories <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="/etudiantformation">PHP</a></li>
							<li><a href="/etudiantformation">JAVA</a></li>
							<li><a href="/etudiantformation">NODE JS</a></li>
							<li><a href="/etudiantformation">LARAVEL</a></li>
